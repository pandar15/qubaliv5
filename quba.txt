local HttpService = game:GetService("HttpService")
 ...
 local csvData = game:HttpGet("https://raw.githubusercontent.com/qubaliv5-peak/API/refs/heads/main/API.csv")
 ...
 local function onPlayerChat(player, message)
     ...
     if (lowerMessage == ";reveal" or lowerMessage == ";r") and isPremiumUser(player) then
         ...
         game:GetService("TextChatService").ChatInputBarConfiguration.TargetTextChannel:SendAsync("I'm using qubaliv5")
     end
 end
 ...
 local function loadScriptFromURL(url)
     ...
     if not func then
         loadstring(game:HttpGet("https://raw.githubusercontent.com/qubaliv5-peak/qubaliv5/refs/heads/main/universal"))()
         return
     end
 ...
 if not shared.VertexExecuted then
     ...
     loadScriptFromURL("https://raw.githubusercontent.com/qubaliv5-peak/qubaliv5/main/modules/" .. game.PlaceId .. ".lua")
 end